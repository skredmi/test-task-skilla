  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.menuItems}>
        <Button
          prefix={<Icon nameIcon="chartTimelineVariant" />}
        ...
        <Button
          prefix={<Icon nameIcon="documents" />}
          className={styles.menuItem}
          theme="transparent"
        >
          Документы
        ...
        <Button
          prefix={<Icon nameIcon="permIdentify" />}
          className={styles.menuItem}
          theme="transparent"
          nameIcon="permIdentify"
        >
          Исполнители
        </Button>
        <Button
          prefix={<Icon nameIcon="briefcase" />}
          className={styles.menuItem}
          theme="transparent"
        >
          Отчеты
        ...
        <Button
          prefix={<Icon nameIcon="localLibrary" />}
          className={styles.menuItem}
          theme="transparent"
        >
          База знаний
      ...
      <div className={styles.buttons}>
        <Button theme="primary" className={styles.buttonsItem} postfix={<Icon nameIcon="plus" />}>
          Добавить заказ
        </Button>
        <Button theme="primary" className={styles.buttonsItem} postfix={<Icon nameIcon="exclamationMark" />}>
          Оплата
        </Button>
      </div>
    </div>
